...
Claude should list 19 tools including `memory_write`, `memory_recall`, `memory_restore`, `memory_whoami`, etc. (17 memory tools + 2 onboarding tools, `onboard_scan`/`onboard_questions`).
